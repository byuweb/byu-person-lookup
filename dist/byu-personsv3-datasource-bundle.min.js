 ...
 */class Template{constructor(e,t){this.parts=[],this.element=t;let n=-1,a=0;const r=[],d=t=>{const s=t.content,o=document.createTreeWalker(s,133/* NodeFilter.SHOW_{ELEMENT|COMMENT|TEXT} */,null,!1);// Edge needs all 4 parameters present; IE11 needs 3rd parameter to be
// null
for(// Keeps track of the last index associated with a part. We try to delete
// unnecessary nodes, but we never want to associate two different parts
// to the same index. They must have a constant node between.
let s=0;o.nextNode();){n++;const t=o.currentNode;if(1===t.nodeType/* Node.ELEMENT_NODE */){if(t.hasAttributes()){const r=t.attributes;// Per
...
const r=e.strings[a],d=lastAttributeNameRegex.exec(r)[2],s=d.toLowerCase()+boundAttributeSuffix,o=t.getAttribute(s),i=o.split(markerRegex);// Find the attribute name
this.parts.push({type:"attribute",index:n,name:d,strings:i}),t.removeAttribute(s),a+=i.length-1}}"TEMPLATE"===t.tagName&&d(t)}else if(3===t.nodeType/* Node.TEXT_NODE */){const e=t.data;if(0<=e.indexOf(marker)){const d=t.parentNode,s=e.split(markerRegex),o=s.length-1;// Generate a new text node for each literal section
 ...
 * removed 4 nodes)
 */function removeNodesFromTemplate(e,t){const{element:{content:a},parts:n}=e,r=document.createTreeWalker(a,walkerNodeFilter,null,!1);let d=nextActiveIndexInTemplateParts(n),s=n[d],o=-1,i=0;const l=[];for(let a=null;r.nextNode();){o++;const e=r.currentNode;// End removal if stepped past the removing node
for(e.previousSibling===a&&(a=null),t.has(e)&&(l.push(e),null===a&&(a=e)),null!==a&&i++;s!==void 0&&s.index===o;)// If part is in a removed node deactivate it by setting index to -1 or
// adjust the index as needed.
// go to the next active part.
s.index=null===a?s.index-i:-1,d=nextActiveIndexInTemplateParts(n,d),s=n[d]}l.forEach(e=>e.parentNode.removeChild(e))}const countNodes=e=>{let t=11===e.nodeType/* Node.DOCUMENT_FRAGMENT_NODE */?0:1;for(const n=document.createTreeWalker(e,walkerNodeFilter,null,!1);n.nextNode();)t++;return t},nextActiveIndexInTemplateParts=(e,t=-1)=>{for(let n=t+1;n<e.length;n++){const t=e[n];if(isTemplatePartActive(t))return n}return-1};/**
...
if(null===n||void 0===n)return void r.appendChild(t);const d=document.createTreeWalker(r,walkerNodeFilter,null,!1);let s=nextActiveIndexInTemplateParts(a),o=0,i=-1;for(;d.nextNode();){i++;const e=d.currentNode;for(e===n&&(o=countNodes(t),n.parentNode.insertBefore(t,n));-1!==s&&a[s].index===i;){// If we've inserted the node, simply adjust all subsequent parts
if(0<o){for(;-1!==s;)a[s].index+=o,s=nextActiveIndexInTemplateParts(a,s);return}s=nextActiveIndexInTemplateParts(a,s)}}}/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 * http://polymer.github.io/LICENSE.txt
...
if(render(e,o,Object.assign({templateFactory:shadyTemplateFactory(a)},n)),s){const e=parts.get(o);parts.delete(o),e.value instanceof TemplateInstance&&prepareTemplateStyles(o,e.value.template,a),removeNodes(t,t.firstChild),t.appendChild(o),parts.set(t,e)}// After elements have hit the DOM, update styling if this is the
