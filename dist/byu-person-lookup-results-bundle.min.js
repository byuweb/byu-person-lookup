...
const e=()=>[1,2,3,4,5,6].map(()=>html`
    ...
    `:html``}dispatch(e,t){const n=t?{detail:t,bubbles:!0,composed:!0}:{bubbles:!0,composed:!0},r=new CustomEvent(e,n);this.dispatchEvent(r)}select(e){const{personId:t,byuId:n,netId:r,name:s}=e;this.dispatch("byu-lookup-results-select",{personId:t,byuId:n,netId:r,name:s}),this.close()}close(){this.dispatch("byu-lookup-results-close"),this.isObserving=!1}next(){this.searchPending||this.dispatch("byu-lookup-next-page")}prev(){this.searchPending||this.dispatch("byu-lookup-prev-page")}}export default ByuPersonLookupResults;
