 ...
 */const dedupingMixin=function(e){function t(t){let r=/** @type {!MixinFunction} */t.__mixinSet;if(r&&r[a])return t;let i=n,d=i.get(t);d||(d=/** @type {!Function} */e(t),i.set(t,d));// copy inherited mixin set from the extended class, or the base class
// NOTE: we avoid use of Set here because some browser (IE11)
// cannot extend a base Set via the constructor.
let s=Object.create(/** @type {!MixinFunction} */d.__mixinSet||r||null);return s[a]=!0,d.__mixinSet=s,d}let n=/** @type {!MixinFunction} */e.__mixinApplications;n||(n=new WeakMap,e.__mixinApplications=n);// maintain a unique id for each mixin
...
let r=-1,i=0;const d=[];// The actual previous node, accounting for removals: if a node is removed
...
const a=e.strings[i],d=lastAttributeNameRegex.exec(a)[1],s=n.getNamedItem(d),o=s.value.split(markerRegex);// Find the attribute name
// Find the corresponding attribute
// TODO(justinfagnani): remove non-null assertion
this.parts.push(new TemplatePart('attribute',r,s.name,d,o)),t.removeAttribute(s.name),i+=o.length-1}}else if(3===t.nodeType/* Node.TEXT_NODE */){const e=t.nodeValue;if(0>e.indexOf(marker))continue;const n=t.parentNode,a=e.split(markerRegex),s=a.length-1;// We have a part for each match found
i+=s;// Generate a new text node for each literal section
// These nodes are also used as the markers for node parts
for(let e=0;e<s;e++)n.insertBefore(''===a[e]?document.createComment(''):document.createTextNode(a[e]),t),this.parts.push(new TemplatePart('node',r++));n.insertBefore(''===a[s]?document.createComment(''):document.createTextNode(a[s]),t),d.push(t)}else if(8===t.nodeType/* Node.COMMENT_NODE */&&t.nodeValue===marker){const e=t.parentNode,a=t.previousSibling;// Add a new marker node to be the startNode of the Part if any of the
// following are true:
...
null===a||a!==n||a.nodeType!==Node.TEXT_NODE?e.insertBefore(document.createComment(''),t):r--,this.parts.push(new TemplatePart('node',r++)),d.push(t),null===t.nextSibling?e.insertBefore(document.createComment(''),t):r--,s=n,i++}}// Remove text binding nodes after the walk to not disturb the TreeWalker
for(const a of d)a.parentNode.removeChild(a)}}/**
...
const n=document.createTreeWalker(e,133/* NodeFilter.SHOW_ELEMENT | NodeFilter.SHOW_COMMENT |
                   NodeFilter.SHOW_TEXT */,null,!1);let a=-1;for(let e=0;e<t.length;e++){const r=t[e],i=isTemplatePartActive(r);// An inactive part has no coresponding Template node.
if(i)for(;a<r.index;)a++,n.nextNode();this._parts.push(i?this._partCallback(this,r,n.currentNode):void 0)}}return e}}/**
 * Reparents nodes, starting from `startNode` (inclusive) to `endNode`
 * (exclusive), into another container (could be the same container), before
 * `beforeNode`. If `beforeNode` is null, it appends the nodes to the
 * container.
 */const reparentNodes=(e,t,n=null,a=null)=>{for(let r=t;r!==n;){const t=r.nextSibling;e.insertBefore(r,a),r=t}},removeNodes=(e,t,n=null)=>{for(let a=t;a!==n;){const t=a.nextSibling;e.removeChild(a),a=t}},walkerNodeFilter=NodeFilter.SHOW_ELEMENT|NodeFilter.SHOW_COMMENT|NodeFilter.SHOW_TEXT;/**
 ...
 */function removeNodesFromTemplate(e,t){const{element:{content:a},parts:n}=e,r=document.createTreeWalker(a,walkerNodeFilter,null,!1);let i=0,d=n[0],s=-1,o=0;const l=[];for(let a=null;r.nextNode();){s++;const e=r.currentNode;// End removal if stepped past the removing node
for(e.previousSibling===a&&(a=null),t.has(e)&&(l.push(e),null===a&&(a=e)),null!==a&&o++;d!==void 0&&d.index===s;)d.index=null===a?d.index-o:-1,d=n[++i]}l.forEach(e=>e.parentNode.removeChild(e))}const countNodes=e=>{let t=1;for(const n=document.createTreeWalker(e,walkerNodeFilter,null,!1);n.nextNode();)t++;return t},nextActiveIndexInTemplateParts=(e,t=-1)=>{for(let n=t+1;n<e.length;n++){const t=e[n];if(isTemplatePartActive(t))return n}return-1};/**
...
if(null===n||void 0===n)return void r.appendChild(t);const i=document.createTreeWalker(r,walkerNodeFilter,null,!1);for(let r=nextActiveIndexInTemplateParts(a),d=0,s=-1;i.nextNode();){s++;const e=i.currentNode;for(e===n&&(n.parentNode.insertBefore(t,n),d=countNodes(t));-1!==r&&a[r].index===s;){// If we've inserted the node, simply adjust all subsequent parts
if(0<d){for(;-1!==r;)a[r].index+=d,r=nextActiveIndexInTemplateParts(a,r);return}r=nextActiveIndexInTemplateParts(a,r)}}}/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 * http://polymer.github.io/LICENSE.txt
...
function render$1(e,t,n){const a=shadyTemplateFactory(n),r=a(e);let i=t.__templateInstance;// Repeat render, just call update()
if(void 0!==i&&i.template===r&&i._partCallback===e.partCallback)return void i.update(e.values);// First render, create a new TemplateInstance and append it
i=new TemplateInstance(r,e.partCallback,a),t.__templateInstance=i;const d=i._clone();i.update(e.values);const s=t instanceof ShadowRoot?t.host:void 0;// If there's a shadow host, do ShadyCSS scoping...
s!==void 0&&'object'==typeof window.ShadyCSS&&(ensureStylesScoped(d,r,n),window.ShadyCSS.styleElement(s)),removeNodes(t,t.firstChild),t.appendChild(d)}/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 * http://polymer.github.io/LICENSE.txt
 ...
 */const html$1=(e,...t)=>new TemplateResult(e,t,'html',extendedPartCallback),svg$1=(e,...t)=>new SVGTemplateResult(e,t,'svg',extendedPartCallback),extendedPartCallback=(e,t,n)=>{if('attribute'===t.type){if('on-'===t.rawName.substr(0,3)){const a=t.rawName.slice(3);return new EventPart(e,n,a)}const a=t.name.substr(t.name.length-1);if('$'===a){const a=t.name.slice(0,-1);return new AttributePart(e,n,a,t.strings)}if('?'===a){const a=t.name.slice(0,-1);return new BooleanAttributePart(e,n,a,t.strings)}return new PropertyPart(e,n,t.rawName,t.strings)}return defaultPartCallback(e,t,n)};/**
...
`,r=()=>html$1`
    ...
    `,s=()=>[1,2,3,4,5,6].map(()=>html$1`
      <tr class="placeholder"><td colspan="5">${r()}</td></tr>
    `),o=e=>/ACT|LEV/.test(e.employeeType)?html$1`
        ...
        `:html$1`<div></div>`,[,,,,l]=faEnvelope.icon,[,,,,_]=faPhone.icon,[,,,,p]=faHome.icon,u=e=>html$1`
    ...
    `,c=e=>html$1`
      <div class="card" on-click="${()=>this.select(e)}">
        ...
        <div class="contact">
          <div>${u(l)}${e.email}</div>
          <div>${u(_)}${e.phone}</div>
          <div>${u(p)}${e.addresses.mailing?i(e.addresses.mailing):''}</div>
        </div>
      </div>
    ...
    `);if(!e||!e.map||1>e.length)return html$1``;const[,,,,f]=faTimes.icon,g=svg$1`
    <path d$=${f} fill="white" transform="translate(90)"/>
    `;return html$1`
      ${a}
      <div class="modal">
        <div class="results">
    ...
    `}dispatch(e,t){const n=t?{detail:t,bubbles:!0,composed:!0}:{bubbles:!0,composed:!0},a=new CustomEvent(e,n);this.dispatchEvent(a)}select(e){const{personId:t,byuId:n,netId:a,name:r}=e;this.dispatch('byu-lookup-results-select',{personId:t,byuId:n,netId:a,name:r}),this.close()}close(){this.dispatch('byu-lookup-results-close')}next(){this.searchPending||this.dispatch('byu-lookup-next-page')}prev(){this.searchPending||this.dispatch('byu-lookup-prev-page')}_didRender(){const e=this._root.getElementById('top'),t=this._root.getElementById('bottom');if(IntersectionObserver&&e&&t){const n=new IntersectionObserver(n=>{n.forEach(n=>{n.isIntersecting&&(n.target===t?this.next():n.target===e&&this.prev())})},{});// observer.observe(top)
n.observe(t)}}}/*
