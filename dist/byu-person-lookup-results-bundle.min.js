...
`,r=()=>html$1`
    ...
    `),o=e=>/ACT|LEV/.test(e.employeeType)||''===e.employeeType&&e.jobTitle&&e.department?(console.log('render employee'),html$1`
        ...
        `):(console.log('no render employee'),html$1`<div></div>`),[,,,,l]=faEnvelope.icon,[,,,,_]=faPhone.icon,[,,,,p]=faHome.icon,u=e=>html$1`
    ...
    `,c=e=>html$1`
      <div class="card" on-click="${()=>this.select(e)}">
        ...
        <div class="contact">
          <div>${u(l)}${e.email}</div>
          <div>${u(_)}${e.phone}</div>
          <div>${u(p)}${e.addresses?e.addresses.mailing?i(e.addresses.mailing):'':''}</div>
        </div>
      </div>
