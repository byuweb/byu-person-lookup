...
for(e.previousSibling===a&&(a=null),t.has(e)&&(l.push(e),null===a&&(a=e)),null!==a&&o++;i!==void 0&&i.index===s;)i.index=null===a?i.index-o:-1,i=n[++d]}l.forEach(e=>e.parentNode.removeChild(e))}const countNodes=e=>{let t=1;for(const n=document.createTreeWalker(e,walkerNodeFilter,null,!1);n.nextNode();)t++;return t},nextActiveIndexInTemplateParts=(e,t=-1)=>{for(let n=t+1;n<e.length;n++){const t=e[n];if(isTemplatePartActive(t))return n}return-1};/**
...
if(null===n||void 0===n)return void r.appendChild(t);const d=document.createTreeWalker(r,walkerNodeFilter,null,!1);for(let r=nextActiveIndexInTemplateParts(a),i=0,s=-1;d.nextNode();){s++;const e=d.currentNode;for(e===n&&(n.parentNode.insertBefore(t,n),i=countNodes(t));-1!==r&&a[r].index===s;){// If we've inserted the node, simply adjust all subsequent parts
if(0<i){for(;-1!==r;)a[r].index+=i,r=nextActiveIndexInTemplateParts(a,r);return}r=nextActiveIndexInTemplateParts(a,r)}}}/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 * http://polymer.github.io/LICENSE.txt
...
`,r=()=>html$1`
    ...
    `),o=e=>/ACT|LEV/.test(e.employeeType)||''===e.employeeType&&e.jobTitle&&e.department?(console.log('render employee'),html$1`
          <div>
            ...
            <div>${e.addresses?e.addresses.work?d(e.addresses.work):'':''}</div>
          </div>
    ...
    `,c=e=>html$1`
      <div class="card" on-click="${()=>this.select(e)}">
        ...
        <div class="contact">
          <div>${u(l)}${e.email}</div>
          <div>${u(_)}${e.phone}</div>
          <div>${u(p)}${e.addresses?e.addresses.mailing?d(e.addresses.mailing):'':''}</div>
        </div>
      </div>
