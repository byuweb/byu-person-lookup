...
const V=e=>e&&(k?{capture:e.capture,passive:e.passive,once:e.once}:e.capture);/**
     ...
     */const R=new class{/**
         ...
         */handleTextExpression(e){return new N(e)}},I=new Map,z=new WeakMap,M=(t,n,r)=>{let s=z.get(n);s===void 0&&(d(n,n.firstChild),z.set(n,s=new N(Object.assign({templateFactory:e},r))),s.appendInto(n)),s.setValue(t),s.commit()};(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.0.0");/**
     * Interprets a template literal as an HTML template that can efficiently
     * render to and update a container.
     */const L=(e,...t)=>new v(e,t,"html",R),w=(e,...t)=>new S(e,t,"svg",R),q=133/* NodeFilter.SHOW_{ELEMENT|COMMENT|TEXT} */,O=e=>{let t=11===e.nodeType/* Node.DOCUMENT_FRAGMENT_NODE */?0:1;for(const n=document.createTreeWalker(e,q,null,!1);n.nextNode();)t++;return t},U=(e,t=-1)=>{for(let n=t+1;n<e.length;n++){const t=e[n];if(f(t))return n}return-1},H=(e,t)=>`${e}--${t}`;/**
...
if(D(s),n(r,a,r.element.content.firstChild),window.ShadyCSS.prepareTemplateStyles(r.element,s),window.ShadyCSS.nativeShadow){// When in native Shadow DOM, re-add styling to rendered content using
// the style ShadyCSS produced.
const t=r.element.content.querySelector("style");e.insertBefore(t.cloneNode(!0),e.firstChild)}else{r.element.content.insertBefore(a,r.element.content.firstChild);const e=new Set;e.add(a),t(r,e)}},G=(e,t,n)=>{const r=n.scopeName,s=z.has(t),o=t instanceof ShadowRoot&&F&&e instanceof v,a=o&&!j.has(r),i=a?document.createDocumentFragment():t;// When performing first scope render,
...
if(M(e,i,Object.assign({templateFactory:B(r)},n)),a){const e=z.get(i);z.delete(i),e.value instanceof _&&$(i,e.value.template,r),d(t,t.firstChild),t.appendChild(i),z.set(t,e)}// After elements have hit the DOM, update styling if this is the
...
const e=()=>[1,2,3,4,5,6].map(()=>L`
    ...
    `,o=e=>e.showAdditionalInfo&&e.additionalInfo?L`
          <ul>
            ${e.additionalInfo.map(e=>L`<li>${e}</li>`)}
          </ul>
        `:L`<div></div>`,[,,,,a]=ye.icon,[,,,,d]=_e.icon,[,,,,i]=ve.icon,[,,,,l]=me.icon,p=w`
    ...
    `)(this.results)}
          ...
          ${Se?L`<button id="bottom" class="nav-btn" @click=${this.close}>Close</button>`:L`<div>
    ...
    <div class=${this.compact?"compact container":"container"}>
      ...
      <slot name="error">
        <div class=${""===this.errorType?"hidden":"error-display"}>
          ...
          ${"No Results"===this.errorType?this.errorMessage:L`
