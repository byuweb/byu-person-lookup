...
return n=t.keyString.get(r),void 0===n&&(n=new m(e,e.getTemplateElement()),t.keyString.set(r,n)),t.stringsArray.set(e.strings,n),n}/**
     ...
     * removed 4 nodes)
     */function t(e,t){const{element:{content:r},parts:n}=e,s=document.createTreeWalker(r,O,null,!1);let a=U(n),o=n[a],d=-1,i=0;const l=[];for(let r=null;s.nextNode();){d++;const e=s.currentNode;// End removal if stepped past the removing node
...
o.index=null===r?o.index-i:-1,a=U(n,a),o=n[a]}l.forEach(e=>e.parentNode.removeChild(e))}/**
...
if(null===n||void 0===n)return void s.appendChild(t);const a=document.createTreeWalker(s,O,null,!1);let o=U(r),d=0,i=-1;for(;a.nextNode();){i++;const e=a.currentNode;for(e===n&&(d=q(t),n.parentNode.insertBefore(t,n));-1!==o&&r[o].index===i;){// If we've inserted the node, simply adjust all subsequent parts
if(0<d){for(;-1!==o;)r[o].index+=d,o=U(r,o);return}o=U(r,o)}}}/**
     * @license
     * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
     * This code may only be used under the BSD style license found at
     * http://polymer.github.io/LICENSE.txt
...
const r=new WeakMap,s=e=>"function"==typeof e&&r.has(e),a=window.customElements!==void 0&&window.customElements.polyfillWrapFlushCallback!==void 0,o=(e,t,n=null,r=null)=>{for(let s=t;s!==n;){const t=s.nextSibling;e.insertBefore(s,r),s=t}},d=(e,t,n=null)=>{for(let r=t;r!==n;){const t=r.nextSibling;e.removeChild(r),r=t}},i={},l={},p=`{{lit-${(Math.random()+"").slice(2)}}}`,u=`<!--${p}-->`,c=new RegExp(`${p}|${u}`),g="$lit$";/**
     ...
     */class m{constructor(e,t){this.parts=[],this.element=t;let n=-1,r=0;const s=[],a=t=>{const o=t.content,d=document.createTreeWalker(o,133/* NodeFilter.SHOW_{ELEMENT|COMMENT|TEXT} */,null,!1);// Edge needs all 4 parameters present; IE11 needs 3rd parameter to be
// null
...
const s=e.strings[r],a=y.exec(s)[2],o=a.toLowerCase()+g,d=t.getAttribute(o),i=d.split(c);// Find the attribute name
...
for(let e=0;e<d;e++)a.insertBefore(""===o[e]?f():document.createTextNode(o[e]),t),this.parts.push({type:"node",index:++n});// If there's no text, we must insert a comment to mark our place.
// Else, we can trust it will stick around after cloning.
// We have a part for each match found
""===o[d]?(a.insertBefore(f(),t),s.push(t)):t.data=o[d],r+=d}}else if(8===t.nodeType/* Node.COMMENT_NODE */)if(t.data===p){const e=t.parentNode;// Add a new marker node to be the startNode of the Part if any of
// the following are true:
//  * We don't have a previousSibling
//  * The previousSibling is already the start of a previous part
(null===t.previousSibling||n===o)&&(n++,e.insertBefore(f(),t)),o=n,this.parts.push({type:"node",index:n}),null===t.nextSibling?t.data="":(s.push(t),n--),r++}else for(let e=-1;-1!==(e=t.data.indexOf(p,e+1));)// Comment node has a binding marker inside, make an inactive part
...
for(const r of s)r.parentNode.removeChild(r)}}const h=e=>-1!==e.index,f=()=>document.createComment(""),y=/([ \x09\x0a\x0c\x0d])([^\0-\x1F\x7F-\x9F \x09\x0a\x0c\x0d"'>=/]+)([ \x09\x0a\x0c\x0d]*=[ \x09\x0a\x0c\x0d]*(?:[^ \x09\x0a\x0c\x0d"'`<>=]*|"[^"]*|'[^']*))$/;// Allows `document.createComment('')` to be renamed for a
...
"string"!=typeof e&&e[Symbol.iterator]))for(const r of e)n+="string"==typeof r?r:r+"";else n+="string"==typeof e?e:e+""}}return n+=e[t],n}commit(){this.dirty&&(this.dirty=!1,this.element.setAttribute(this.name,this._getValue()))}}class x{constructor(e){this.value=void 0,this.committer=e}setValue(e){e===i||P(e)&&e===this.value||(this.value=e,!s(e)&&(this.committer.dirty=!0))}commit(){for(;s(this.value);){const e=this.value;this.value=i,e(this)}this.value===i||this.committer.commit()}}class N{constructor(e){this.value=void 0,this._pendingValue=void 0,this.options=e}/**
         ...
         *
         * This part must be empty, as its contents are not automatically moved.
         */insertAfterPart(e){e._insert(this.startNode=f()),this.endNode=e.endNode,e.endNode=this.startNode}setValue(e){this._pendingValue=e}commit(){for(;s(this._pendingValue);){const e=this._pendingValue;this._pendingValue=i,e(this)}const e=this._pendingValue;e===i||(P(e)?e!==this.value&&this._commitText(e):e instanceof v?this._commitTemplateResult(e):e instanceof Node?this._commitNode(e):Array.isArray(e)||// tslint:disable-next-line:no-any
...
n=t[r],void 0===n&&(n=new N(this.options),t.push(n),0==r?n.appendIntoPart(this):n.insertAfterPart(t[r-1])),n.setValue(s),n.commit(),r++;r<t.length&&(t.length=r,this.clear(n&&n.endNode))}clear(e=this.startNode){d(this.startNode.parentNode,e.nextSibling,this.endNode)}}/**
     ...
     * a string first.
     */class E extends b{constructor(e,t,n){super(e,t,n),this.single=2===n.length&&""===n[0]&&""===n[1]}_createPart(){return new T(this)}_getValue(){return this.single?this.parts[0].value:super._getValue()}commit(){this.dirty&&(this.dirty=!1,this.element[this.name]=this._getValue())}}class T extends x{}// Detect event listener options support. If the `capture` property is read
...
const V=e=>e&&(k?{capture:e.capture,passive:e.passive,once:e.once}:e.capture);/**
     ...
     */const R=new class{/**
         ...
         */handleAttributeExpressions(e,t,n,r){const s=t[0];if("."===s){const r=new E(e,t.slice(1),n);return r.parts}if("@"===s)return[new A(e,t.slice(1),r.eventContext)];if("?"===s)return[new C(e,t.slice(1),n)];const a=new b(e,t,n);return a.parts}/**
         * Create parts for a text-position binding.
         * @param templateFactory
         */handleTextExpression(e){return new N(e)}},z=new Map,I=new WeakMap,L=(t,n,r)=>{let s=I.get(n);s===void 0&&(d(n,n.firstChild),I.set(n,s=new N(Object.assign({templateFactory:e},r))),s.appendInto(n)),s.setValue(t),s.commit()};(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.0.0");/**
     * Interprets a template literal as an HTML template that can efficiently
     * render to and update a container.
     */const M=(e,...t)=>new v(e,t,"html",R),w=(e,...t)=>new S(e,t,"svg",R),O=133/* NodeFilter.SHOW_{ELEMENT|COMMENT|TEXT} */,q=e=>{let t=11===e.nodeType/* Node.DOCUMENT_FRAGMENT_NODE */?0:1;for(const n=document.createTreeWalker(e,O,null,!1);n.nextNode();)t++;return t},U=(e,t=-1)=>{for(let n=t+1;n<e.length;n++){const t=e[n];if(h(t))return n}return-1},H=(e,t)=>`${e}--${t}`;/**
     ...
     */const B=e=>t=>{const n=H(t.type,e);let r=z.get(n);void 0===r&&(r={stringsArray:new WeakMap,keyString:new Map},z.set(n,r));let s=r.stringsArray.get(t.strings);if(void 0!==s)return s;const a=t.strings.join(p);if(s=r.keyString.get(a),void 0===s){const n=t.getTemplateElement();F&&window.ShadyCSS.prepareTemplateDom(n,e),s=new m(t,n),r.keyString.set(a,s)}return r.stringsArray.set(t.strings,s),s},W=["html","svg"],D=e=>{W.forEach(n=>{const r=z.get(H(n,e));r!==void 0&&r.keyString.forEach(e=>{const{element:{content:n}}=e,r=new Set;// IE 11 doesn't support the iterable param Set constructor
...
const t=r.element.content.querySelector("style");e.insertBefore(t.cloneNode(!0),e.firstChild)}else{r.element.content.insertBefore(o,r.element.content.firstChild);const e=new Set;e.add(o),t(r,e)}},G=(e,t,n)=>{const r=n.scopeName,s=I.has(t),a=t instanceof ShadowRoot&&F&&e instanceof v,o=a&&!j.has(r),i=o?document.createDocumentFragment():t;// When performing first scope render,
...
if(L(e,i,Object.assign({templateFactory:B(r)},n)),o){const e=I.get(i);I.delete(i),e.value instanceof _&&$(i,e.value.template,r),d(t,t.firstChild),t.appendChild(i),I.set(t,e)}// After elements have hit the DOM, update styling if this is the
...
const e=()=>[1,2,3,4,5,6].map(()=>M`
    ...
    `,a=e=>e.showAdditionalInfo&&e.additionalInfo?M`
          <ul>
            ${e.additionalInfo.map(e=>M`<li>${e}</li>`)}
          </ul>
        `:M`<div></div>`,[,,,,o]=fe.icon,[,,,,d]=ye.icon,[,,,,i]=_e.icon,[,,,,l]=he.icon,p=w`
    ...
    `;return this.results&&this.results.map&&!(1>this.results.length)?M`
      <div class="modal">
        <div class="results">
          <h2 id="top">Lookup Results</h2>
          ${this.context&&"admin"===this.context?(t=>M`
      <table>
        <thead>
          <tr>
            <th>Name</th>
    ...
    `)(this.results)}
          ...
          ${ve?M`<button id="bottom" class="nav-btn" @click=${this.close}>Close</button>`:M`<div>
    ...
    <div class=${this.compact?"compact container":"container"}>
      ...
      <slot name="error">
        <div class=${""===this.errorType?"hidden":"error-display"}>
          ...
          ${"No Results"===this.errorType?this.errorMessage:M`
