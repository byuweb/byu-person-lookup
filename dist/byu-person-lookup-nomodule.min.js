(function(){'use strict';/**
     ...
     */function e(e){let t=R.get(e.type);void 0===t&&(t={stringsArray:new WeakMap,keyString:new Map},R.set(e.type,t));let n=t.stringsArray.get(e.strings);if(void 0!==n)return n;// If the TemplateStringsArray is new, generate a key from the strings
...
const V=e=>e&&(k?{capture:e.capture,passive:e.passive,once:e.once}:e.capture);/**
     ...
     */const z=new class{/**
         ...
         */handleTextExpression(e){return new N(e)}},R=new Map,I=new WeakMap,L=(t,n,r)=>{let s=I.get(n);s===void 0&&(d(n,n.firstChild),I.set(n,s=new N(Object.assign({templateFactory:e},r))),s.appendInto(n)),s.setValue(t),s.commit()};(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.0.0");/**
     * Interprets a template literal as an HTML template that can efficiently
     * render to and update a container.
     */const M=(e,...t)=>new v(e,t,"html",z),w=(e,...t)=>new S(e,t,"svg",z),O=133/* NodeFilter.SHOW_{ELEMENT|COMMENT|TEXT} */,q=e=>{let t=11===e.nodeType/* Node.DOCUMENT_FRAGMENT_NODE */?0:1;for(const n=document.createTreeWalker(e,O,null,!1);n.nextNode();)t++;return t},U=(e,t=-1)=>{for(let n=t+1;n<e.length;n++){const t=e[n];if(h(t))return n}return-1},H=(e,t)=>`${e}--${t}`;/**
     ...
     */const B=e=>t=>{const n=H(t.type,e);let r=R.get(n);void 0===r&&(r={stringsArray:new WeakMap,keyString:new Map},R.set(n,r));let s=r.stringsArray.get(t.strings);if(void 0!==s)return s;const a=t.strings.join(p);if(s=r.keyString.get(a),void 0===s){const n=t.getTemplateElement();F&&window.ShadyCSS.prepareTemplateDom(n,e),s=new m(t,n),r.keyString.set(a,s)}return r.stringsArray.set(t.strings,s),s},W=["html","svg"],D=e=>{W.forEach(n=>{const r=R.get(H(n,e));r!==void 0&&r.keyString.forEach(e=>{const{element:{content:n}}=e,r=new Set;// IE 11 doesn't support the iterable param Set constructor
...
this.errorMessage="",this.errorType="",this.results=[],0<this.search.length&&this.fetchFromProvider.bind(this.__lookupProvider)(this.search),this.requestUpdate()}loadNextPage(){// console.log(`loadNextPage`)
this.nextPageFromProvider.bind(this.__lookupProvider)()}loadPrevPage(){// console.log(`loadPrevPage`)
this.prevPageFromProvider.bind(this.__lookupProvider)()}}console.log("registering person lookup"),window.customElements.define("byu-person-lookup",be),console.log("registering person lookup results"),window.customElements.define("byu-person-lookup-results",Pe)})();
