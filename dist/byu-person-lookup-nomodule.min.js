...
this.errorMessage="",this.errorType="",this.results=[],0<this.search.length&&this.fetchFromProvider.call(this.__lookupProvider,this.search),this.requestUpdate()}loadNextPage(){// console.log(`loadNextPage`)
this.nextPageFromProvider.call(this.__lookupProvider)}loadPrevPage(){// console.log(`loadPrevPage`)
this.prevPageFromProvider.call(this.__lookupProvider)}}console.log("registering person lookup"),window.customElements.define("byu-person-lookup",be),console.log("registering person lookup results"),window.customElements.define("byu-person-lookup-results",Pe)})();
