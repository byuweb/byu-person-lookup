...
const V=e=>e&&(A?{capture:e.capture,passive:e.passive,once:e.once}:e.capture);/**
     ...
     */const z=new class{/**
         ...
         */handleAttributeExpressions(e,t,n,r){const s=t[0];if("."===s){const r=new T(e,t.slice(1),n);return r.parts}if("@"===s)return[new k(e,t.slice(1),r.eventContext)];if("?"===s)return[new C(e,t.slice(1),n)];const a=new b(e,t,n);return a.parts}/**
         * Create parts for a text-position binding.
         * @param templateFactory
         */handleTextExpression(e){return new N(e)}},I=new Map,R=new WeakMap,M=(t,n,r)=>{let s=R.get(n);s===void 0&&(d(n,n.firstChild),R.set(n,s=new N(Object.assign({templateFactory:e},r))),s.appendInto(n)),s.setValue(t),s.commit()};(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.0.0");/**
     * Interprets a template literal as an HTML template that can efficiently
     * render to and update a container.
     */const w=(e,...t)=>new v(e,t,"html",z),L=(e,...t)=>new S(e,t,"svg",z),O=133/* NodeFilter.SHOW_{ELEMENT|COMMENT|TEXT} */,q=e=>{let t=11===e.nodeType/* Node.DOCUMENT_FRAGMENT_NODE */?0:1;for(const n=document.createTreeWalker(e,O,null,!1);n.nextNode();)t++;return t},U=(e,t=-1)=>{for(let n=t+1;n<e.length;n++){const t=e[n];if(h(t))return n}return-1},H=(e,t)=>`${e}--${t}`;/**
...
const t=r.element.content.querySelector("style");e.insertBefore(t.cloneNode(!0),e.firstChild)}else{r.element.content.insertBefore(o,r.element.content.firstChild);const e=new Set;e.add(o),t(r,e)}},G=(e,t,n)=>{const r=n.scopeName,s=R.has(t),a=t instanceof ShadowRoot&&F&&e instanceof v,o=a&&!j.has(r),i=o?document.createDocumentFragment():t;// When performing first scope render,
...
if(M(e,i,Object.assign({templateFactory:B(r)},n)),o){const e=R.get(i);R.delete(i),e.value instanceof _&&$(i,e.value.template,r),d(t,t.firstChild),t.appendChild(i),R.set(t,e)}// After elements have hit the DOM, update styling if this is the
...
const e=()=>[1,2,3,4,5,6].map(()=>w`
    ...
    `,a=e=>e.showAdditionalInfo&&e.additionalInfo?w`
          <ul>
            ${e.additionalInfo.map(e=>w`<li>${e}</li>`)}
          </ul>
        `:w`<div></div>`,[,,,,o]=fe.icon,[,,,,d]=ye.icon,[,,,,i]=_e.icon,[,,,,l]=he.icon,p=L`
    ...
    `)(this.results)}
          ...
          ${ve?w`<button id="bottom" class="nav-btn" @click=${this.close}>Close</button>`:w`<div>
