 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const pickFirst=(e,t)=>e||t;function parseLinks(e){const t=lodash_get(e,"persons__next.href"),n=lodash_get(e,"persons__prev.href");return{next:t,prev:n}}function parseAddresses(e){return 400<=e.metadata.validation_response.code?null:e.values.reduce((e,t)=>{const n=[lodash_get(t,"address_line_1.value",""),lodash_get(t,"address_line_2.value",""),lodash_get(t,"address_line_3.value",""),lodash_get(t,"address_line_4.value","")].filter(e=>0<e.trim().length),a={MAL:"mailing",RES:"residential",WRK:"work",PRM:"permanent"}[t.address_type.value]||t.address_type.value;return Object.assign({},e,{[a]:n})},{})}function parseBasic(e){const t=e=>{const t=lodash_get(e,"preferred_surname.value",""),n=lodash_get(e,"preferred_first_name.value","");return`${t}, ${n}`},n=lodash_get(e,"name_lnf.value",t(e))||t(e),a=lodash_get(e,"byu_id.value",""),r=lodash_get(e,"net_id.value",""),s=lodash_get(e,"person_id.value","");return{name:n,byuId:a,netId:r,personId:s}}function parseEmailAddresses(e){return 400<=e.metadata.validation_response.code?null:e.values.map(t=>lodash_get(t,"email_address.value","")).map(t=>t.trim()).filter(t=>0<t.length).reduce(pickFirst,"")}function parsePhones(e){return 400<=e.metadata.validation_response.code?null:e.values.map(e=>lodash_get(e,"phone_number.value","")).map(e=>e.trim()).filter(e=>0<e.length).reduce(pickFirst,"")}function parseEmployeeSummaries(e){return 400<=e.metadata.validation_response.code?null:{employeeStatus:lodash_get(e,"employee_type.value"),department:lodash_get(e,"department.value"),jobTitle:lodash_get(e,"job_title.description")}}function parseStudentSummaries(e){if(400<=e.metadata.validation_response.code)return null;const t=lodash_get(e,"student_status.value");return{studentStatus:t}}function pickAddress(e){return e?e.mailing?e.mailing:e.residential?e.mailing:e.permanent?e.permanent:[]:[]}function isEmployee(e){return e.employeeStatus?/ACT|LEV/.test(e.employeeStatus):e.department&&e.jobTitle}function buildAdditionalInfo(e){const t=e.addresses.work?e.addresses.work:[];return[e.department,e.jobTitle,...t]}function parsePerson(e){const t=Object.assign({addresses:parseAddresses(e.addresses),email:parseEmailAddresses(e.email_addresses),phone:parsePhones(e.phones)},parseBasic(e.basic),parseEmployeeSummaries(e.employee_summaries),parseStudentSummaries(e.student_summaries)),n=pickAddress(t.addresses),{email:a,phone:r,name:s,byuId:d,netId:i,employeeStatus:o,studentStatus:l}=t,p=isEmployee(t),u=p?buildAdditionalInfo(t):[];return{address:n,email:a,phone:r,name:s,byuId:d,netId:i,employeeStatus:o,studentStatus:l,showAdditionalInfo:p,additionalInfo:u}}function parsePersonV2(e){const t=e.values.map(parsePerson),{next:n,prev:a}=parseLinks(e.links);return{next:n,prev:a,people:t}}/*
 * Copyright 2018 Brigham Young University
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
