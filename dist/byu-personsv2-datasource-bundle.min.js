 ...
 */function memoize(e,t){if('function'!=typeof e||t&&'function'!=typeof t)throw new TypeError(FUNC_ERROR_TEXT);var n=function(){var a=arguments,r=t?t.apply(this,a):a[0],i=n.cache;if(i.has(r))return i.get(r);var d=e.apply(this,a);return n.cache=i.set(r,d),d};return n.cache=new(memoize.Cache||MapCache),n}// Assign cache to `_.memoize`.
...
r=new TemplateInstance(a,e.partCallback,n),t.__templateInstance=r;const i=r._clone();r.update(e.values),removeNodes(t,t.firstChild),t.appendChild(i)}/**
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const executePersonsv2Request=async(e,t,n)=>{try{const{next:a,prev:r,people:i}=await search(e,n);return t.dispatchEvent(new CustomEvent('byu-lookup-datasource-result',{bubbles:!0,detail:i})),{next:a,prev:r}}catch(e){console.error(e),t.dispatchEvent(new CustomEvent('byu-lookup-datasource-error',{bubbles:!0,detail:e}))}},setPendingSearch=e=>{const t=new CustomEvent('byu-lookup-datasource-searching',{bubbles:!0});e.dispatchEvent(t)};class ByuPersonsv2Datasource extends LitElement{connectedCallback(){super.connectedCallback(),connect();const e=new CustomEvent('byu-lookup-datasource-register',{bubbles:!0});this.dispatchEvent(e)}disconnectedCallback(){super.disconnectedCallback(),disconnect()}static get properties(){return{search:String,next:String,prev:String}}_render({search:e}){e||(e='');const{label:t}=resolveSearchType(e);return html$1`${t}`}async performSearch(){this.timeout&&clearTimeout(this.timeout),this.timeout=setTimeout(async()=>{setPendingSearch(this);const{next:e,prev:t}=await executePersonsv2Request(this.search,this);this.next=e,this.prev=t},100)}async nextPage(){this.timeout&&clearTimeout(this.timeout),this.timeout=setTimeout(async()=>{if(this.next){setPendingSearch(this);const{next:e,prev:t}=await executePersonsv2Request(this.search,this,this.next);this.next=e,this.prev=t}},100)}async prevPage(){this.timeout&&clearTimeout(this.timeout),this.timeout=setTimeout(async()=>{if(this.prev){setPendingSearch(this);const{next:e,prev:t}=await executePersonsv2Request(this.search,this,this.prev);this.next=e,this.prev=t}},100)}}console.log('registering personsv2 datasource'),window.customElements.define('byu-personsv2-datasource',ByuPersonsv2Datasource);
