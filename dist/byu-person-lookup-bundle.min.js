 ...
 */function removeNodesFromTemplate(e,t){const{element:{content:r},parts:n}=e,a=document.createTreeWalker(r,walkerNodeFilter,null,!1);let i=0,s=n[0],d=-1,o=0;const l=[];for(let r=null;a.nextNode();){d++;const e=a.currentNode;// End removal if stepped past the removing node
for(e.previousSibling===r&&(r=null),t.has(e)&&(l.push(e),null===r&&(r=e)),null!==r&&o++;s!==void 0&&s.index===d;)s.index=null===r?s.index-o:-1,s=n[++i]}l.forEach(e=>e.parentNode.removeChild(e))}const countNodes=e=>{let t=1;for(const n=document.createTreeWalker(e,walkerNodeFilter,null,!1);n.nextNode();)t++;return t},nextActiveIndexInTemplateParts=(e,t=-1)=>{for(let n=t+1;n<e.length;n++){const t=e[n];if(isTemplatePartActive(t))return n}return-1};/**
...
if(null===n||void 0===n)return void a.appendChild(t);const i=document.createTreeWalker(a,walkerNodeFilter,null,!1);for(let a=nextActiveIndexInTemplateParts(r),s=0,d=-1;i.nextNode();){d++;const e=i.currentNode;for(e===n&&(n.parentNode.insertBefore(t,n),s=countNodes(t));-1!==a&&r[a].index===d;){// If we've inserted the node, simply adjust all subsequent parts
if(0<s){for(;-1!==a;)r[a].index+=s,a=nextActiveIndexInTemplateParts(r,a);return}a=nextActiveIndexInTemplateParts(r,a)}}}/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 * http://polymer.github.io/LICENSE.txt
...
i=new TemplateInstance(a,e.partCallback,r),t.__templateInstance=i;const s=i._clone();i.update(e.values);const d=t instanceof ShadowRoot?t.host:void 0;// If there's a shadow host, do ShadyCSS scoping...
d!==void 0&&'object'==typeof window.ShadyCSS&&(ensureStylesScoped(s,a,n),window.ShadyCSS.styleElement(d)),removeNodes(t,t.firstChild),t.appendChild(s)}/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 * http://polymer.github.io/LICENSE.txt
...
const[,,,,a]=faSearch.icon,[,,,,i]=faSpinner.icon,[,,,,s]=faBan.icon,[,,,,d]=faExclamationTriangle.icon,o=html$1`
      <style>
        :host {
    ...
    <div class="container">
      ...
      <slot name="error">
        <div class$="${''===this.errorType?'hidden':'error-display'}">
          ...
          ${svg$1`
            <path
              d$="${'No Results'===this.errorType?s:d}"
              fill="white"
            />
          `}
          </svg>
