 ...
 */class Template{constructor(e,t){this.parts=[],this.element=t;let n=-1,r=0;const s=[],a=t=>{const d=t.content,o=document.createTreeWalker(d,133/* NodeFilter.SHOW_{ELEMENT|COMMENT|TEXT} */,null,!1);// Edge needs all 4 parameters present; IE11 needs 3rd parameter to be
// null
for(// Keeps track of the last index associated with a part. We try to delete
// unnecessary nodes, but we never want to associate two different parts
// to the same index. They must have a constant node between.
let d=0;o.nextNode();){n++;const t=o.currentNode;if(1===t.nodeType/* Node.ELEMENT_NODE */){if(t.hasAttributes()){const s=t.attributes;// Per
...
const s=e.strings[r],a=lastAttributeNameRegex.exec(s)[2],d=a.toLowerCase()+boundAttributeSuffix,o=t.getAttribute(d),i=o.split(markerRegex);// Find the attribute name
this.parts.push({type:"attribute",index:n,name:a,strings:i}),t.removeAttribute(d),r+=i.length-1}}"TEMPLATE"===t.tagName&&a(t)}else if(3===t.nodeType/* Node.TEXT_NODE */){const e=t.data;if(0<=e.indexOf(marker)){const a=t.parentNode,d=e.split(markerRegex),o=d.length-1;// Generate a new text node for each literal section
 ...
 * removed 4 nodes)
 */function removeNodesFromTemplate(e,t){const{element:{content:r},parts:n}=e,s=document.createTreeWalker(r,walkerNodeFilter,null,!1);let a=nextActiveIndexInTemplateParts(n),d=n[a],o=-1,i=0;const l=[];for(let r=null;s.nextNode();){o++;const e=s.currentNode;// End removal if stepped past the removing node
for(e.previousSibling===r&&(r=null),t.has(e)&&(l.push(e),null===r&&(r=e)),null!==r&&i++;d!==void 0&&d.index===o;)// If part is in a removed node deactivate it by setting index to -1 or
// adjust the index as needed.
// go to the next active part.
d.index=null===r?d.index-i:-1,a=nextActiveIndexInTemplateParts(n,a),d=n[a]}l.forEach(e=>e.parentNode.removeChild(e))}const countNodes=e=>{let t=11===e.nodeType/* Node.DOCUMENT_FRAGMENT_NODE */?0:1;for(const n=document.createTreeWalker(e,walkerNodeFilter,null,!1);n.nextNode();)t++;return t},nextActiveIndexInTemplateParts=(e,t=-1)=>{for(let n=t+1;n<e.length;n++){const t=e[n];if(isTemplatePartActive(t))return n}return-1};/**
...
if(null===n||void 0===n)return void s.appendChild(t);const a=document.createTreeWalker(s,walkerNodeFilter,null,!1);let d=nextActiveIndexInTemplateParts(r),o=0,i=-1;for(;a.nextNode();){i++;const e=a.currentNode;for(e===n&&(o=countNodes(t),n.parentNode.insertBefore(t,n));-1!==d&&r[d].index===i;){// If we've inserted the node, simply adjust all subsequent parts
if(0<o){for(;-1!==d;)r[d].index+=o,d=nextActiveIndexInTemplateParts(r,d);return}d=nextActiveIndexInTemplateParts(r,d)}}}/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 * http://polymer.github.io/LICENSE.txt
...
const n=t.element.content.querySelector("style");e.insertBefore(n.cloneNode(!0),e.firstChild)}else{t.element.content.insertBefore(s,t.element.content.firstChild);const e=new Set;e.add(s),removeNodesFromTemplate(t,e)}},render$1=(e,t,n)=>{const r=n.scopeName,s=parts.has(t),a=t instanceof ShadowRoot&&compatibleShadyCSSVersion&&e instanceof TemplateResult,d=a&&!shadyRenderSet.has(r),o=d?document.createDocumentFragment():t;// When performing first scope render,
...
if(render(e,o,Object.assign({templateFactory:shadyTemplateFactory(r)},n)),d){const e=parts.get(o);parts.delete(o),e.value instanceof TemplateInstance&&prepareTemplateStyles(o,e.value.template,r),removeNodes(t,t.firstChild),t.appendChild(o),parts.set(t,e)}// After elements have hit the DOM, update styling if this is the
...
const e=()=>[1,2,3,4,5,6].map(()=>html`
    ...
    `,a=e=>/ACT|LEV/.test(e.employeeType)||""===e.employeeType&&e.jobTitle&&e.department?html`
        ...
        `:html`<div></div>`,[,,,,d]=faEnvelope.icon,[,,,,o]=faPhone.icon,[,,,,i]=faHome.icon,[,,,,l]=faTimes.icon,p=svg`
    ...
    <div class=${this.compact?"compact container":"container"}>
      ...
      <slot name="error">
        <div class=${""===this.errorType?"hidden":"error-display"}>
          ...
          ${svg`
            <path
              d=${"No Results"===this.errorType?a:d}
              fill="white"
            />
          `}
          </svg>
