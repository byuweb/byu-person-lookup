 ...
 */const dedupingMixin=function(e){function t(t){let a=/** @type {!MixinFunction} */t.__mixinSet;if(a&&a[n])return t;let s=r,i=s.get(t);i||(i=/** @type {!Function} */e(t),s.set(t,i));// copy inherited mixin set from the extended class, or the base class
// NOTE: we avoid use of Set here because some browser (IE11)
// cannot extend a base Set via the constructor.
let o=Object.create(/** @type {!MixinFunction} */i.__mixinSet||a||null);return o[n]=!0,i.__mixinSet=o,i}let r=/** @type {!MixinFunction} */e.__mixinApplications;r||(r=new WeakMap,e.__mixinApplications=r);// maintain a unique id for each mixin
let n=dedupeId++;return(/** @type {T} */t)};/* eslint-enable valid-jsdoc *//**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
The complete set of authors may be found at http://polymer.github.io/AUTHORS.txt
...
let microtaskCurrHandle=0,microtaskLastHandle=0,microtaskCallbacks=[],microtaskNodeContent=0,microtaskNode=document.createTextNode('');new window.MutationObserver(microtaskFlush).observe(microtaskNode,{characterData:!0});function microtaskFlush(){const e=microtaskCallbacks.length;for(let t,r=0;r<e;r++)if(t=microtaskCallbacks[r],t)try{t()}catch(t){setTimeout(()=>{throw t})}microtaskCallbacks.splice(0,e),microtaskLastHandle+=e}/**
 ...
 */const microTask={/**
   ...
   */class extends e{/**
     ...
     * @return {void}
     * @protected
     */static createProperties(e){const t=this.prototype;for(let r in e)// don't stomp an existing accessor
r in t||t._createPropertyAccessor(r)}/**
...
for(let e in this.__dataHasAccessor)this.hasOwnProperty(e)&&(this.__dataInstanceProps=this.__dataInstanceProps||{},this.__dataInstanceProps[e]=this[e],delete this[e])}/**
     ...
     * @protected
     */_setPendingProperty(e,t){let r=this.__data[e],n=this._shouldPropertyChange(e,t,r);return n&&(!this.__dataPending&&(this.__dataPending={},this.__dataOld={}),this.__dataOld&&!(e in this.__dataOld)&&(this.__dataOld[e]=r),this.__data[e]=t,this.__dataPending[e]=t),n}/* eslint-enable *//**
     ...
     * @return {void}
     * @protected
     */_flushProperties(){const e=this.__data,t=this.__dataPending,r=this.__dataOld;this._shouldPropertiesChange(e,t,r)&&(this.__dataPending=null,this.__dataOld=null,this._propertiesChanged(e,t,r))}/**
...
/**
     ...
     * @protected
     */_shouldPropertyChange(e,t,r){return(// Strict equality check
r!==t&&(// This ensures (old==NaN, value==NaN) always returns false
r===r||t===t))}/**
     ...
     */attributeChangedCallback(e,t,r,n){t!==r&&this._attributeToProperty(e,r),super.attributeChangedCallback&&super.attributeChangedCallback(e,t,r,n)}/**
     ...
     * @return {void}
     */_attributeToProperty(e,t,r){if(!this.__serializing){const n=this.__dataAttributes,a=n&&n[e]||e;this[a]=this._deserializeValue(t,r||this.constructor.typeForProperty(a))}}/**
     ...
     * @return {void}
     */_propertyToAttribute(e,t,r){this.__serializing=!0,r=3>arguments.length?this[e]:r,this._valueToNodeAttribute(/** @type {!HTMLElement} */this,r,t||this.constructor.attributeNameForProperty(e)),this.__serializing=!1}/**
     ...
     * @return {void}
     */_valueToNodeAttribute(e,t,r){const n=this._serializeValue(t);n===void 0?e.removeAttribute(r):e.setAttribute(r,n)}/**
 ...
 * @private
 */function normalizeProperties(e){const t={};for(let r in e){const n=e[r];t[r]='function'==typeof n?{type:n}:n}return t}/**
...
return t.prototype instanceof a?/** @type {PropertiesMixinConstructor} */t:null}/**
  ...
  */function r(e){if(!e.hasOwnProperty(JSCompiler_renameProperty('__ownProperties',e))){let t=null;e.hasOwnProperty(JSCompiler_renameProperty('properties',e))&&e.properties&&(t=normalizeProperties(e.properties)),e.__ownProperties=t}return e.__ownProperties}/**
  * @polymer
  * @mixinClass
  * @extends {base}
  ...
  * @extends {superClass}
  * @implements {Polymer_PropertiesChanged}
  */const n=PropertiesChanged(e);class a extends n{/**
    ...
    *
    * @protected
    */static _finalizeClass(){const e=r(/** @type {PropertiesMixinConstructor} */this);e&&this.createProperties(e)}/**
    ...
    * @protected
    */static get _properties(){if(!this.hasOwnProperty(JSCompiler_renameProperty('__properties',this))){const e=t(/** @type {PropertiesMixinConstructor} */this);this.__properties=Object.assign({},e&&e._properties,r(/** @type {PropertiesMixinConstructor} */this))}return this.__properties}/**
 ...
 */class TemplateResult{constructor(e,t,r,n=defaultPartCallback){this.strings=e,this.values=t,this.type=r,this.partCallback=n}/**
     * Returns a string of HTML used to create a <template> element.
     */getHTML(){const e=this.strings.length-1;let t='',r=!0;for(let n=0;n<e;n++){const e=this.strings[n];t+=e;// We're in a text position if the previous string closed its tags.
// If it doesn't have any tags, then we use the previous text position
// state.
const a=findTagClose(e);r=-1<a?a<e.length:r,t+=r?nodeMarker:marker}return t+=this.strings[e],t}getTemplateElement(){const e=document.createElement('template');return e.innerHTML=this.getHTML(),e}}/**
 * A TemplateResult for SVG fragments.
 *
 * This class wraps HTMl in an <svg> tag in order to parse its contents in the
 * SVG namespace, then modifies the template to remove the <svg> tag so that
 * clones only container the original fragment.
 */class SVGTemplateResult extends TemplateResult{getHTML(){return`<svg>${super.getHTML()}</svg>`}getTemplateElement(){const e=super.getTemplateElement(),t=e.content,r=t.firstChild;return t.removeChild(r),reparentNodes(t,r.firstChild),e}}/**
 * The default TemplateFactory which caches Templates keyed on
 * result.type and result.strings.
 */function defaultTemplateFactory(e){let t=templateCaches.get(e.type);void 0===t&&(t=new Map,templateCaches.set(e.type,t));let r=t.get(e.strings);return void 0===r&&(r=new Template(e,e.getTemplateElement()),t.set(e.strings,r)),r}/**
 ...
 *     cache.
 */function render(e,t,r=defaultTemplateFactory){const n=r(e);let a=t.__templateInstance;// Repeat render, just call update()
if(void 0!==a&&a.template===n&&a._partCallback===e.partCallback)return void a.update(e.values);// First render, create a new TemplateInstance and append it
a=new TemplateInstance(n,e.partCallback,r),t.__templateInstance=a;const s=a._clone();a.update(e.values),removeNodes(t,t.firstChild),t.appendChild(s)}/**
 ...
 */function findTagClose(e){const t=e.lastIndexOf('>'),r=e.indexOf('<',t+1);return-1<r?e.length:t}/**
 ...
 * to Part.update().
 */class TemplatePart{constructor(e,t,r,n,a){this.type=e,this.index=t,this.name=r,this.rawName=n,this.strings=a}}/**
 * An updateable Template that tracks the location of dynamic parts.
 */class Template{constructor(e,t){this.parts=[],this.element=t;const r=this.element.content,n=document.createTreeWalker(r,133/* NodeFilter.SHOW_ELEMENT | NodeFilter.SHOW_COMMENT |
               NodeFilter.SHOW_TEXT */,null,!1);// Edge needs all 4 parameters present; IE11 needs 3rd parameter to be null
let a=-1,s=0;const i=[];// The actual previous node, accounting for removals: if a node is removed
// it will never be the previousNode.
// Used to set previousNode at the top of the loop.
for(let r,o;n.nextNode();){a++,r=o;const t=o=n.currentNode;if(1===t.nodeType/* Node.ELEMENT_NODE */){if(!t.hasAttributes())continue;const r=t.attributes;// Per https://developer.mozilla.org/en-US/docs/Web/API/NamedNodeMap,
// attributes are not guaranteed to be returned in document order. In
// particular, Edge/IE can return them out of order, so we cannot assume
// a correspondance between part index and attribute index.
let n=0;for(let e=0;e<r.length;e++)0<=r[e].value.indexOf(marker)&&n++;for(;0<n--;){// Get the template literal section leading up to the first
// expression in this attribute attribute
const n=e.strings[s],i=lastAttributeNameRegex.exec(n)[1],o=r.getNamedItem(i),d=o.value.split(markerRegex);// Find the attribute name
// Find the corresponding attribute
// TODO(justinfagnani): remove non-null assertion
this.parts.push(new TemplatePart('attribute',a,o.name,i,d)),t.removeAttribute(o.name),s+=d.length-1}}else if(3===t.nodeType/* Node.TEXT_NODE */){const e=t.nodeValue;if(0>e.indexOf(marker))continue;const r=t.parentNode,n=e.split(markerRegex),o=n.length-1;// We have a part for each match found
s+=o;// Generate a new text node for each literal section
// These nodes are also used as the markers for node parts
for(let e=0;e<o;e++)r.insertBefore(''===n[e]?document.createComment(''):document.createTextNode(n[e]),t),this.parts.push(new TemplatePart('node',a++));r.insertBefore(''===n[o]?document.createComment(''):document.createTextNode(n[o]),t),i.push(t)}else if(8===t.nodeType/* Node.COMMENT_NODE */&&t.nodeValue===marker){const e=t.parentNode,n=t.previousSibling;// Add a new marker node to be the startNode of the Part if any of the
// following are true:
...
null===n||n!==r||n.nodeType!==Node.TEXT_NODE?e.insertBefore(document.createComment(''),t):a--,this.parts.push(new TemplatePart('node',a++)),i.push(t),null===t.nextSibling?e.insertBefore(document.createComment(''),t):a--,o=r,s++}}// Remove text binding nodes after the walk to not disturb the TreeWalker
 ...
 */class AttributePart{constructor(e,t,r,n){this.instance=e,this.element=t,this.name=r,this.strings=n,this.size=n.length-1,this._previousValues=[]}_interpolate(e,t){const r=this.strings,n=r.length-1;let a='';for(let s=0;s<n;s++){a+=r[s];const n=getValue(this,e[t+s]);if(n&&n!==directiveValue&&(Array.isArray(n)||'string'!=typeof n&&n[Symbol.iterator]))for(const e of n)// TODO: we need to recursively call getValue into iterables...
a+=e;else a+=n}return a+r[n]}_equalToPreviousValues(e,t){for(let r=t;r<t+this.size;r++)if(this._previousValues[r]!==e[r]||!isPrimitiveValue(e[r]))return!1;return!0}setValue(e,t){if(this._equalToPreviousValues(e,t))return;const r=this.strings;let n;2===r.length&&''===r[0]&&''===r[1]?(n=getValue(this,e[t]),Array.isArray(n)&&(n=n.join(''))):n=this._interpolate(e,t),n!==directiveValue&&this.element.setAttribute(this.name,n),this._previousValues=e}}class NodePart{constructor(e,t,r){this.instance=e,this.startNode=t,this.endNode=r,this._previousValue=void 0}setValue(e){if(e=getValue(this,e),e!==directiveValue)if(isPrimitiveValue(e)){// Handle primitive values
// If the value didn't change, do nothing
if(e===this._previousValue)return;this._setText(e)}else e instanceof TemplateResult?this._setTemplateResult(e):Array.isArray(e)||e[Symbol.iterator]?this._setIterable(e):e instanceof Node?this._setNode(e):void 0===e.then?this._setText(e):this._setPromise(e)}_insert(e){this.endNode.parentNode.insertBefore(e,this.endNode)}_setNode(e){this._previousValue===e||(this.clear(),this._insert(e),this._previousValue=e)}_setText(e){const t=this.startNode.nextSibling;e=e===void 0?'':e,t===this.endNode.previousSibling&&t.nodeType===Node.TEXT_NODE?t.textContent=e:this._setNode(document.createTextNode(e)),this._previousValue=e}_setTemplateResult(e){const t=this.instance._getTemplate(e);let r;this._previousValue&&this._previousValue.template===t?r=this._previousValue:(r=new TemplateInstance(t,this.instance._partCallback,this.instance._getTemplate),this._setNode(r._clone()),this._previousValue=r),r.update(e.values)}_setIterable(e){Array.isArray(this._previousValue)||(this.clear(),this._previousValue=[]);// Lets us keep track of how many items we stamped so we can clear leftover
// items from a previous render
const t=this._previousValue;let r=0;for(const n of e){// Try to reuse an existing part
let e=t[r];// If no existing part, create a new one
if(e===void 0){// If we're creating the first item part, it's startNode should be the
// container's startNode
let n=this.startNode;// If we're not creating the first part, create a new separator marker
// node, and fix up the previous part's endNode to point to it
if(0<r){const e=t[r-1];n=e.endNode=document.createTextNode(''),this._insert(n)}e=new NodePart(this.instance,n,this.endNode),t.push(e)}e.setValue(n),r++}if(0==r)this.clear(),this._previousValue=void 0;else if(r<t.length){const e=t[r-1];// Truncate the parts array so _previousValue reflects the current state
t.length=r,this.clear(e.endNode.previousSibling),e.endNode=this.endNode}}_setPromise(e){this._previousValue=e,e.then(t=>{this._previousValue===e&&this.setValue(t)})}clear(e=this.startNode){removeNodes(this.startNode.parentNode,e.nextSibling,this.endNode)}}const defaultPartCallback=(e,t,r)=>{if('attribute'===t.type)return new AttributePart(e,r,t.name,t.strings);if('node'===t.type)return new NodePart(e,r,r.nextSibling);throw new Error(`Unknown part type ${t.type}`)};/**
 * An instance of a `Template` that can be attached to the DOM and updated
 * with new values.
 */class TemplateInstance{constructor(e,t,r){this._parts=[],this.template=e,this._partCallback=t,this._getTemplate=r}update(e){let t=0;for(const r of this._parts)void 0===r.size?(r.setValue(e[t]),t++):(r.setValue(e,t),t+=r.size)}_clone(){const e=document.importNode(this.template.element.content,!0),t=this.template.parts;if(0<t.length){// Edge needs all 4 parameters present; IE11 needs 3rd parameter to be
// null
const r=document.createTreeWalker(e,133/* NodeFilter.SHOW_ELEMENT | NodeFilter.SHOW_COMMENT |
                   NodeFilter.SHOW_TEXT */,null,!1);let n=-1;for(let e=0;e<t.length;e++){const a=t[e];for(;n<a.index;)n++,r.nextNode();this._parts.push(this._partCallback(this,a,r.currentNode))}}return e}}/**
 * Reparents nodes, starting from `startNode` (inclusive) to `endNode`
 * (exclusive), into another container (could be the same container), before
 * `beforeNode`. If `beforeNode` is null, it appends the nodes to the
 * container.
 */const reparentNodes=(e,t,r=null,a=null)=>{for(let s=t;s!==r;){const t=s.nextSibling;e.insertBefore(s,a),s=t}},removeNodes=(e,t,r=null)=>{for(let a=t;a!==r;){const t=a.nextSibling;e.removeChild(a),a=t}},shadyTemplateFactory=e=>t=>{const r=`${t.type}--${e}`;let n=templateCaches.get(r);n===void 0&&(n=new Map,templateCaches.set(r,n));let a=n.get(t.strings);if(a===void 0){const r=t.getTemplateElement();'object'==typeof window.ShadyCSS&&window.ShadyCSS.prepareTemplate(r,e),a=new Template(t,r),n.set(t.strings,a)}return a};/**
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */function render$1(e,t,r){return render(e,t,shadyTemplateFactory(r))}/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 * http://polymer.github.io/LICENSE.txt
 ...
 */const html$1=(e,...t)=>new TemplateResult(e,t,'html',extendedPartCallback),svg$1=(e,...t)=>new SVGTemplateResult(e,t,'svg',extendedPartCallback),extendedPartCallback=(e,t,r)=>{if('attribute'===t.type){if('on-'===t.rawName.substr(0,3)){const n=t.rawName.slice(3);return new EventPart(e,r,n)}const n=t.name.substr(t.name.length-1);if('$'===n){const n=t.name.slice(0,-1);return new AttributePart(e,r,n,t.strings)}if('?'===n){const n=t.name.slice(0,-1);return new BooleanAttributePart(e,r,n,t.strings)}return new PropertyPart(e,r,t.rawName,t.strings)}return defaultPartCallback(e,t,r)};/**
 ...
 */class BooleanAttributePart extends AttributePart{setValue(e,t){const r=this.strings;if(2===r.length&&''===r[0]&&''===r[1]){const r=getValue(this,e[t]);if(r===directiveValue)return;r?this.element.setAttribute(this.name,''):this.element.removeAttribute(this.name)}else throw new Error('boolean attributes can only contain a single expression')}}class PropertyPart extends AttributePart{setValue(e,t){const r=this.strings;let n;this._equalToPreviousValues(e,t)||(n=2===r.length&&''===r[0]&&''===r[1]?getValue(this,e[t]):this._interpolate(e,t),n!==directiveValue&&(this.element[this.name]=n),this._previousValues=e)}}class EventPart{constructor(e,t,r){this.instance=e,this.element=t,this.eventName=r}setValue(e){const t=getValue(this,e);t===this._listener||(null==t?this.element.removeEventListener(this.eventName,this):null==this._listener&&this.element.addEventListener(this.eventName,this),this._listener=t)}handleEvent(e){'function'==typeof this._listener?this._listener.call(this.element,e):'function'==typeof this._listener.handleEvent&&this._listener.handleEvent(e)}}class LitElement extends PropertiesMixin(HTMLElement){constructor(){super(...arguments),this.__renderComplete=null,this.__resolveRenderComplete=null,this.__isInvalid=!1,this.__isChanging=!1}/**
     ...
     */_shouldPropertiesChange(e,t,r){const n=this._shouldRender(e,t,r);return!n&&this.__resolveRenderComplete&&this.__resolveRenderComplete(!1),n}/**
     ...
     */_propertiesChanged(e,t,r){super._propertiesChanged(e,t,r);const n=this._render(e);n&&this._root!==void 0&&this._applyRender(n,this._root),this._didRender(e,t,r),this.__resolveRenderComplete&&this.__resolveRenderComplete(!0)}_flushProperties(){this.__isChanging=!0,this.__isInvalid=!1,super._flushProperties(),this.__isChanging=!1}/**
     * Override which warns when a user attempts to change a property during
     * the rendering lifecycle. This is an anti-pattern and should be avoided.
     * @param property {string}
     * @param value {any}
     * @param old {any}
     */_shouldPropertyChange(e,t,r){const n=super._shouldPropertyChange(e,t,r);return n&&this.__isChanging&&console.trace(`Setting properties in response to other properties changing `+`considered harmful. Setting '${e}' from `+`'${this._getProperty(e)}' to '${t}'.`),n}/**
 ...
 */const{IntersectionObserver,CustomEvent}=window;class ByuPersonLookupResults extends LitElement{static get properties(){return{results:Array,context:String,searchPending:Boolean}}_render({results:e,context:t,searchPending:r}){// console.log(`byu-person-lookup-results::_render::searchPending=${searchPending}`)
const n=html$1`
      <style>
        :host {
          padding: 1rem;
...
`,a=()=>html$1`
    ...
    `,o=()=>[1,2,3,4,5,6].map(()=>html$1`
      <tr class="placeholder"><td colspan="5">${a()}</td></tr>
    `),d=e=>/ACT|LEV/.test(e.employeeType)||''===e.employeeType&&e.jobTitle&&e.department?(console.log('render employee'),html$1`
          <div>
            <div>${e.jobTitle}</div>
            <div>${e.department}</div>
            <div>${e.addresses?e.addresses.work?s(e.addresses.work):'':''}</div>
          </div>
        `):(console.log('no render employee'),html$1`<div></div>`),[,,,,l]=faEnvelope.icon,[,,,,p]=faPhone.icon,[,,,,_]=faHome.icon,c=e=>html$1`
    ...
    `,u=e=>html$1`
      <div class="card" on-click="${()=>this.select(e)}">
        ...
        <div class="contact">
          <div>${c(l)}${e.email}</div>
          <div>${c(p)}${e.phone}</div>
          <div>${c(_)}${e.addresses?e.addresses.mailing?s(e.addresses.mailing):'':''}</div>
        </div>
      </div>
    `,m=()=>[1,2,3,4,5,6].map(()=>html$1`
    ...
    `}dispatch(e,t){const r=t?{detail:t,bubbles:!0,composed:!0}:{bubbles:!0,composed:!0},n=new CustomEvent(e,r);this.dispatchEvent(n)}select(e){const{personId:t,byuId:r,netId:n,name:a}=e;this.dispatch('byu-lookup-results-select',{personId:t,byuId:r,netId:n,name:a}),this.close()}close(){this.dispatch('byu-lookup-results-close')}next(){this.searchPending||this.dispatch('byu-lookup-next-page')}prev(){this.searchPending||this.dispatch('byu-lookup-prev-page')}_didRender(){const e=this._root.getElementById('top'),t=this._root.getElementById('bottom');if(IntersectionObserver&&e&&t){const r=new IntersectionObserver(r=>{r.forEach(r=>{r.isIntersecting&&(r.target===t?this.next():r.target===e&&this.prev())})},{});// observer.observe(top)
r.observe(t)}}}/*
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ByuPersonLookup extends LitElement{static get properties(){return{context:String,errorMessage:String,errorType:String,results:Object,search:String,searchPending:Boolean}}constructor(){super(),this.context='directory',this.errorMessage='',this.errorType='',this.results=null,this.search='',this.searchPending=!1}_render({search:e,results:t,searchPending:r,context:n}){// console.log(`search=${search}, context=${context}`)
const[,,,,a]=faSearch.icon,[,,,,s]=faSpinner.icon,[,,,,i]=faBan.icon,[,,,,o]=faExclamationTriangle.icon,d=html$1`
      <style>
        :host {
    ...
    <div class="container">
      ...
      <slot name="error">
        <div class$="${''===this.errorType?'hidden':'error-display'}">
          ...
          ${svg$1`
            <path
              d$="${'No Results'===this.errorType?i:o}"
              fill="white"
            />
          `}
          </svg>
          ${'No Results'===this.errorType?this.errorMessage:html$1`Oops! Something went wrong. <div class="small-padding"><small>${this.errorMessage}</small></div>`}
        </div>
      </slot>
    </div>
    <slot name="results">
    ...
    `}closeResults(){this.results=null}registerProvider(e){this.__lookupProvider=e,this.addEventListener('byu-lookup-datasource-result',this.searchResults),this.addEventListener('byu-lookup-datasource-error',this.searchError),this.addEventListener('byu-lookup-datasource-searching',this.searchBegun),this.fetchFromProvider=this.__lookupProvider.performSearch,this.nextPageFromProvider=this.__lookupProvider.nextPage,this.prevPageFromProvider=this.__lookupProvider.prevPage}connectedCallback(){super.connectedCallback();const e=this.firstElementChild;if(e&&e.performSearch)this.registerProvider(e);else{const t=setTimeout(()=>{throw new Error('No valid lookup provider found!')},1e4);this.addEventListener('byu-lookup-datasource-register',r=>{r.stopPropagation(),this.registerProvider(r.target),clearTimeout(t)})}}searchResults(t){return t.stopPropagation(),console.log('search results:\n',t.detail),this.searchPending=!1,0===t.detail.length&&0===this.results.length?(this.errorMessage='Hmmm, we couldn\'t find anyone.',void(this.errorType='No Results')):void(this.results=this.results.concat(t.detail))}searchError(t){t.stopPropagation(),this.searchPending=!1,this.errorMessage=t.detail,this.errorType='Service Error',console.error('search error:\n',t.detail)}searchBegun(t){t.stopPropagation(),this.searchPending=!0}searchChange(t){// console.log(`search=${this.search}`)
if(this.errorMessage='',this.errorType='',this.search=t.target.value,this.__lookupProvider){const e=this.search;this.__lookupProvider.search=e}}doSearch(){this.errorMessage='',this.errorType='',this.results=[],0<this.search.length&&this.fetchFromProvider(this.search)}loadNextPage(){this.nextPageFromProvider()}loadPrevPage(){this.prevPageFromProvider()}}console.log('registering person lookup'),window.customElements.define('byu-person-lookup',ByuPersonLookup),console.log('registering person lookup results'),window.customElements.define('byu-person-lookup-results',ByuPersonLookupResults);export default ByuPersonLookup;
