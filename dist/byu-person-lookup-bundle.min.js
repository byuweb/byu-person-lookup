 ...
 */const dedupingMixin=function(e){function t(t){let a=/** @type {!MixinFunction} */t.__mixinSet;if(a&&a[r])return t;let i=n,d=i.get(t);d||(d=/** @type {!Function} */e(t),i.set(t,d));// copy inherited mixin set from the extended class, or the base class
// NOTE: we avoid use of Set here because some browser (IE11)
// cannot extend a base Set via the constructor.
let s=Object.create(/** @type {!MixinFunction} */d.__mixinSet||a||null);return s[r]=!0,d.__mixinSet=s,d}let n=/** @type {!MixinFunction} */e.__mixinApplications;n||(n=new WeakMap,e.__mixinApplications=n);// maintain a unique id for each mixin
let r=dedupeId++;return t};/* eslint-enable valid-jsdoc */ /**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
The complete set of authors may be found at http://polymer.github.io/AUTHORS.txt
 ...
 * to Part.update().
 */class TemplatePart{constructor(e,t,n,r,a){this.type=e,this.index=t,this.name=n,this.rawName=r,this.strings=a}}const isTemplatePartActive=e=>-1!==e.index;/**
...
let a=-1,i=0;const d=[];// The actual previous node, accounting for removals: if a node is removed
// it will never be the previousNode.
let s,o;// Used to set previousNode at the top of the loop.
for(;r.nextNode();){a++,s=o;const t=o=r.currentNode;if(1===t.nodeType/* Node.ELEMENT_NODE */){if(!t.hasAttributes())continue;const n=t.attributes;// Per https://developer.mozilla.org/en-US/docs/Web/API/NamedNodeMap,
...
const r=e.strings[i],d=lastAttributeNameRegex.exec(r)[1],s=n.getNamedItem(d),o=s.value.split(markerRegex);// Find the attribute name
this.parts.push(new TemplatePart("attribute",a,s.name,d,o)),t.removeAttribute(s.name),i+=o.length-1}}else if(3===t.nodeType/* Node.TEXT_NODE */){const e=t.nodeValue;if(0>e.indexOf(marker))continue;const n=t.parentNode,r=e.split(markerRegex),s=r.length-1;i+=s;// Generate a new text node for each literal section
// These nodes are also used as the markers for node parts
for(let e=0;e<s;e++)n.insertBefore(""===r[e]?document.createComment(""):document.createTextNode(r[e]),t),this.parts.push(new TemplatePart("node",a++));n.insertBefore(""===r[s]?document.createComment(""):document.createTextNode(r[s]),t),d.push(t)}else if(8===t.nodeType/* Node.COMMENT_NODE */&&t.nodeValue===marker){const e=t.parentNode,n=t.previousSibling;// Add a new marker node to be the startNode of the Part if any of the
// following are true:
...
null===n||n!==s||n.nodeType!==Node.TEXT_NODE?e.insertBefore(document.createComment(""),t):a--,this.parts.push(new TemplatePart("node",a++)),d.push(t),null===t.nextSibling?e.insertBefore(document.createComment(""),t):a--,o=s,i++}}// Remove text binding nodes after the walk to not disturb the TreeWalker
for(const r of d)r.parentNode.removeChild(r)}}/**
 * Returns a value ready to be inserted into a Part from a user-provided value.
 *
 * If the user value is a directive, this invokes the directive with the given
 * part. If the value is null, it's converted to undefined to work better
 * with certain DOM APIs, like textContent.
 */const getValue=(e,t)=>isDirective(t)?(t=t(e),noChange):null===t?void 0:t,isDirective=e=>"function"==typeof e&&!0===e.__litDirective,noChange={},isPrimitiveValue=e=>null===e||"object"!=typeof e&&"function"!=typeof e;class AttributePart{constructor(e,t,n,r){this.instance=e,this.element=t,this.name=n,this.strings=r,this.size=r.length-1,this._previousValues=[]}_interpolate(e,t){const n=this.strings,r=n.length-1;let a="";for(let d=0;d<r;d++){a+=n[d];const r=getValue(this,e[t+d]);if(r&&r!==noChange&&(Array.isArray(r)||"string"!=typeof r&&r[Symbol.iterator]))for(const e of r)// TODO: we need to recursively call getValue into iterables...
a+=e;else a+=r}return a+n[r]}_equalToPreviousValues(e,t){for(let n=t;n<t+this.size;n++)if(this._previousValues[n]!==e[n]||!isPrimitiveValue(e[n]))return!1;return!0}setValue(e,t){if(this._equalToPreviousValues(e,t))return;const n=this.strings;let r;2===n.length&&""===n[0]&&""===n[1]?(r=getValue(this,e[t]),Array.isArray(r)&&(r=r.join(""))):r=this._interpolate(e,t),r!==noChange&&this.element.setAttribute(this.name,r),this._previousValues=e}}class NodePart{constructor(e,t,n){this.instance=e,this.startNode=t,this.endNode=n,this._previousValue=void 0}setValue(e){if(e=getValue(this,e),e!==noChange)if(isPrimitiveValue(e)){// Handle primitive values
...
const n=document.createTreeWalker(e,133/* NodeFilter.SHOW_ELEMENT | NodeFilter.SHOW_COMMENT |
                   NodeFilter.SHOW_TEXT */,null,!1);let r=-1;for(let e=0;e<t.length;e++){const a=t[e],i=isTemplatePartActive(a);// An inactive part has no coresponding Template node.
if(i)for(;r<a.index;)r++,n.nextNode();this._parts.push(i?this._partCallback(this,a,n.currentNode):void 0)}}return e}}/**
 * Reparents nodes, starting from `startNode` (inclusive) to `endNode`
 * (exclusive), into another container (could be the same container), before
 * `beforeNode`. If `beforeNode` is null, it appends the nodes to the
 * container.
 */const reparentNodes=(e,t,n=null,r=null)=>{for(let a=t;a!==n;){const t=a.nextSibling;e.insertBefore(a,r),a=t}},removeNodes=(e,t,n=null)=>{for(let r=t;r!==n;){const t=r.nextSibling;e.removeChild(r),r=t}},walkerNodeFilter=NodeFilter.SHOW_ELEMENT|NodeFilter.SHOW_COMMENT|NodeFilter.SHOW_TEXT;/**
 ...
 */function removeNodesFromTemplate(e,t){const{element:{content:r},parts:n}=e,a=document.createTreeWalker(r,walkerNodeFilter,null,!1);let i=0,d=n[0],s=-1,o=0;const l=[];for(let r=null;a.nextNode();){s++;const e=a.currentNode;// End removal if stepped past the removing node
for(e.previousSibling===r&&(r=null),t.has(e)&&(l.push(e),null===r&&(r=e)),null!==r&&o++;d!==void 0&&d.index===s;)// If part is in a removed node deactivate it by setting index to -1 or
// adjust the index as needed.
d.index=null===r?d.index-o:-1,d=n[++i]}l.forEach(e=>e.parentNode.removeChild(e))}const countNodes=e=>{let t=1;for(const n=document.createTreeWalker(e,walkerNodeFilter,null,!1);n.nextNode();)t++;return t},nextActiveIndexInTemplateParts=(e,t=-1)=>{for(let n=t+1;n<e.length;n++){const t=e[n];if(isTemplatePartActive(t))return n}return-1};/**
...
if(null===n||void 0===n)return void a.appendChild(t);const i=document.createTreeWalker(a,walkerNodeFilter,null,!1);let d=nextActiveIndexInTemplateParts(r),s=0,o=-1;for(;i.nextNode();){o++;const e=i.currentNode;for(e===n&&(n.parentNode.insertBefore(t,n),s=countNodes(t));-1!==d&&r[d].index===o;){// If we've inserted the node, simply adjust all subsequent parts
if(0<s){for(;-1!==d;)r[d].index+=s,d=nextActiveIndexInTemplateParts(r,d);return}d=nextActiveIndexInTemplateParts(r,d)}}}/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 * http://polymer.github.io/LICENSE.txt
...
const getTemplateCacheKey=(e,t)=>`${e}--${t}`,shadyTemplateFactory=e=>t=>{const n=getTemplateCacheKey(t.type,e);let r=templateCaches.get(n);r===void 0&&(r=new Map,templateCaches.set(n,r));let a=r.get(t.strings);if(a===void 0){const n=t.getTemplateElement();"object"==typeof window.ShadyCSS&&window.ShadyCSS.prepareTemplateDom(n,e),a=new Template(t,n),r.set(t.strings,a)}return a},TEMPLATE_TYPES=["html","svg"];/**
...
if(!shadyRenderSet.has(n)){shadyRenderSet.add(n);const r=document.createElement("template");// ApplyShim case
if(Array.from(e.querySelectorAll("style")).forEach(e=>{r.content.appendChild(e)}),window.ShadyCSS.prepareTemplateStyles(r,n),removeStylesFromLitTemplates(n),window.ShadyCSS.nativeShadow){const n=r.content.querySelector("style");null!==n&&(e.insertBefore(n,e.firstChild),insertNodeIntoTemplate(t,n.cloneNode(!0),t.element.content.firstChild))}}};/**
...
function render$1(e,t,n){const r=shadyTemplateFactory(n),a=r(e);let i=t.__templateInstance;// Repeat render, just call update()
if(void 0!==i&&i.template===a&&i._partCallback===e.partCallback)return void i.update(e.values);// First render, create a new TemplateInstance and append it
i=new TemplateInstance(a,e.partCallback,r),t.__templateInstance=i;const d=i._clone();i.update(e.values);const s=t instanceof ShadowRoot?t.host:void 0;// If there's a shadow host, do ShadyCSS scoping...
s!==void 0&&"object"==typeof window.ShadyCSS&&(ensureStylesScoped(d,a,n),window.ShadyCSS.styleElement(s)),removeNodes(t,t.firstChild),t.appendChild(d)}/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 * http://polymer.github.io/LICENSE.txt
 ...
 */const{IntersectionObserver,CustomEvent}=window;class ByuPersonLookupResults extends LitElement{static get properties(){return{results:Array,context:String,searchPending:Boolean}}_render({results:e,context:t,searchPending:n}){// console.log(`byu-person-lookup-results::_render::searchPending=${searchPending}`)
const r=html$1`
      <style>
        :host {
          padding: 1rem;
...
`,a=()=>html$1`
    ...
    `,s=()=>[1,2,3,4,5,6].map(()=>html$1`
      <tr class="placeholder"><td colspan="5">${a()}</td></tr>
    `),o=e=>/ACT|LEV/.test(e.employeeType)||""===e.employeeType&&e.jobTitle&&e.department?(console.log("render employee"),html$1`
          <div>
            <div>${e.jobTitle}</div>
            <div>${e.department}</div>
            <div>${e.addresses?e.addresses.work?i(e.addresses.work):"":""}</div>
          </div>
        `):(console.log("no render employee"),html$1`<div></div>`),[,,,,l]=faEnvelope.icon,[,,,,p]=faPhone.icon,[,,,,c]=faHome.icon,_=e=>html$1`
    ...
    `,u=e=>html$1`
      <div class="card" on-click="${()=>this.select(e)}">
        ...
        <div class="contact">
          <div>${_(l)}${e.email}</div>
          <div>${_(p)}${e.phone}</div>
          <div>${_(c)}${e.addresses?e.addresses.mailing?i(e.addresses.mailing):"":""}</div>
        </div>
      </div>
...
const[,,,,a]=faSearch.icon,[,,,,i]=faSpinner.icon,[,,,,d]=faBan.icon,[,,,,s]=faExclamationTriangle.icon,o=html$1`
    ...
    <div class="container">
      ...
      <slot name="error">
        <div class$="${""===this.errorType?"hidden":"error-display"}">
          ...
          ${svg$1`
            <path
              d$="${"No Results"===this.errorType?d:s}"
              fill="white"
            />
          `}
          </svg>
    ...
    `}closeResults(){this.results=null}registerProvider(e){this.__lookupProvider=e,this.addEventListener("byu-lookup-datasource-result",this.searchResults),this.addEventListener("byu-lookup-datasource-error",this.searchError),this.addEventListener("byu-lookup-datasource-searching",this.searchBegun),this.fetchFromProvider=this.__lookupProvider.performSearch,this.nextPageFromProvider=this.__lookupProvider.nextPage,this.prevPageFromProvider=this.__lookupProvider.prevPage}connectedCallback(){super.connectedCallback();const e=this.firstElementChild;if(e&&e.performSearch)this.registerProvider(e);else{const t=setTimeout(()=>{throw new Error("No valid lookup provider found!")},1e4);this.addEventListener("byu-lookup-datasource-register",n=>{n.stopPropagation(),this.registerProvider(n.target),clearTimeout(t)})}}searchResults(t){return t.stopPropagation(),console.log("search results:\n",t.detail),this.searchPending=!1,0===t.detail.length&&0===this.results.length?(this.errorMessage="Hmmm, we couldn't find anyone.",void(this.errorType="No Results")):void(this.results=this.results.concat(t.detail))}searchError(t){// Don't trigger any other lookup components
// window.alert(e.detail)
t.stopPropagation(),this.searchPending=!1,this.errorMessage=t.detail,this.errorType="Service Error",console.error("search error:\n",t.detail)}searchBegun(t){// Don't trigger any other lookup components
t.stopPropagation(),this.searchPending=!0}searchChange(t){// console.log(`search=${this.search}`)
if(this.errorMessage="",this.errorType="",this.search=t.target.value,this.__lookupProvider){const e=this.search;this.__lookupProvider.search=e}}doSearch(){// console.log(`doSearch:search: ${this.search}`)
this.errorMessage="",this.errorType="",this.results=[],0<this.search.length&&this.fetchFromProvider(this.search)}loadNextPage(){// console.log(`loadNextPage`)
this.nextPageFromProvider()}loadPrevPage(){// console.log(`loadPrevPage`)
this.prevPageFromProvider()}}console.log("registering person lookup"),window.customElements.define("byu-person-lookup",ByuPersonLookup),console.log("registering person lookup results"),window.customElements.define("byu-person-lookup-results",ByuPersonLookupResults);export default ByuPersonLookup;
