...
this.prevPageFromProvider.bind(this.__lookupProvider)()}}console.log("registering person lookup"),window.customElements.define("byu-person-lookup",ByuPersonLookup),console.log("registering person lookup results"),window.customElements.define("byu-person-lookup-results",ByuPersonLookupResults);
