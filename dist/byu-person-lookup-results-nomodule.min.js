...
const I=e=>e&&(V?{capture:e.capture,passive:e.passive,once:e.once}:e.capture);/**
     ...
     */const k=new class{/**
         ...
         */handleTextExpression(e){return new N(e)}},w=new Map,O=new WeakMap,R=(t,n,r)=>{let a=O.get(n);a===void 0&&(i(n,n.firstChild),O.set(n,a=new N(Object.assign({templateFactory:e},r))),a.appendInto(n)),a.setValue(t),a.commit()};(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.0.0");/**
...
Array.from(n.querySelectorAll("style")).forEach(e=>{r.add(e)}),t(e,r)})})},D=new Set,$=(e,r,a)=>{D.add(a);// Move styles out of rendered DOM and store.
...
if(j(a),n(r,d,r.element.content.firstChild),window.ShadyCSS.prepareTemplateStyles(r.element,a),window.ShadyCSS.nativeShadow){// When in native Shadow DOM, re-add styling to rendered content using
...
if(R(e,o,Object.assign({templateFactory:F(r)},n)),d){const e=O.get(o);O.delete(o),e.value instanceof y&&$(o,e.value.template,r),i(t,t.firstChild),t.appendChild(o),O.set(t,e)}// After elements have hit the DOM, update styling if this is the
// initial render to this container.
// This is needed whenever dynamic changes are made so it would be
// safest to do every render; however, this would regress performance
// so we leave it up to the user to call `ShadyCSSS.styleElement`
// for dynamic changes.
!a&&s&&window.ShadyCSS.styleElement(t.host)},J=e=>e,K=(e,t)=>{if(e in t)for(;t!==Object.prototype;){if(t.hasOwnProperty(e))return Object.getOwnPropertyDescriptor(t,e);t=Object.getPrototypeOf(t)}},Q={toAttribute(e,t){return t===Boolean?e?"":null:t===Object||t===Array?null==e?e:JSON.stringify(e):e},fromAttribute(e,t){return t===Boolean?null!==e:t===Number?null===e?null:+e:t===Object||t===Array?JSON.parse(e):e}},X=(e,t)=>t!==e&&(t===t||e===e),Y={attribute:!0,type:String,converter:Q,reflect:!1,hasChanged:X},Z=Promise.resolve(!0),ee=1,te=4,ne=8,re=16,ae=32;/**
...
this.createProperty(n,e[n])}}}/**
         ...
         * @nocollapse
         */static _propertyValueFromAttribute(e,t){const n=t.type,r=t.converter||Q,a="function"==typeof r?r:r.fromAttribute;return a?a(e,n):e}/**
         ...
         * @nocollapse
         */static _propertyValueToAttribute(e,t){if(void 0===t.reflect)return;const n=t.type,r=t.converter,a=r&&r.toAttribute||Q.toAttribute;return a(e,n)}/**
         ...
         */attributeChangedCallback(e,t,n){t!==n&&this._attributeToProperty(e,n)}_propertyToAttribute(e,t,n=Y){const r=this.constructor,a=r._attributeNameForProperty(e,n);if(a!==void 0){const e=r._propertyValueToAttribute(t,n);// an undefined value does not change the attribute.
